                                    ...
                                    <table id="ingredientTable" class="table" style="width:100%;">
                                        ...
                                        <tbody id="stringOptsBody">
                                            <tr id="row">
                                                ...
                                                <td>
                                                    <select style="color:${darkMode?'white':'black'};background-color:${darkMode?'black':'white'};" name="ingredientUnit" class="form-control" required="required">
                                                ...
                                                <td>
                                                    <a style="color:${darkMode?'white':'black'};text-decoration:none;" class="btn btn-outline-danger" href="javascript:removeRow('optRow')"><b>X</b></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <script>
