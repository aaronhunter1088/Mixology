...
<html>
    ...
    <div id="content" role="main">
        <div class="container">
            ...
            <section class="row">
                <div id="list-tune" class="col-12 content scaffold-list" role="main">
                    <h1><g:message code="default.list.label" args="[entityName]" /></h1>
                    <g:if test="${flash.message}">
                        <div class="message" role="status">${flash.message}</div>
                    </g:if>
                    <f:table collection="${songList}" />

                    <g:if test="${songCount > params.int('max')}">
                    <div class="pagination">
                        <g:paginate total="${songCount ?: 0}" />
                    </div>
                    </g:if>
                </div>
            </section>
