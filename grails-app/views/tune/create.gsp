...
<html>
    <head>
        ...
        <g:set var="entityName" value="${message(code: 'tune.label', default: 'Song')}" />
    ...
    <div id="content" role="main">
        <div class="container">
            ...
            <section class="row">
                <div id="create-song" class="col-12 content scaffold-create" role="main">
                    ...
                    <g:form resource="${this.tune}" method="POST">
                        <fieldset class="form">
                            <f:all bean="song"/>
                        </fieldset>
