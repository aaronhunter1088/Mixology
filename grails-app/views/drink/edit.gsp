                                    ...
                                    <div style="margin-top:-25px;height:419px;overflow-y:auto;">
                                        <g:each in="${Ingredient.list(sort: ['amount':'asc','name':'asc'])}" var="ingredient" status="i">
                                            <g:if test="${drink.ingredients.contains(ingredient)}">
                                                <div style="display:block;">
                                                    ...
                                                    <input hidden type="checkbox" name="ingredients" id="ingredient${ingredient.id}" checked value="${ingredient}"/> ${ingredient} : ${ingredient.id} &emsp14;
                                                </div>
                                            </g:if>
                                        </g:each>
                                        <g:each in="${ingredients}" var="ingredient" status="i">
                                            <div style="display:block;">
                                                ...
                                                <input hidden type="checkbox" name="ingredients" id="ingredient${ingredient.id}" value="${ingredient}"/> ${ingredient} : ${ingredient.id} &emsp14;
                                            </div>
                                        </g:each>
                                    </div>
                                </div>
