...
<% } else {
    if ( testing ) { %>
        <p>If you want to create your own drinks, you can create your own account with Mixology by clicking <a href="http://localhost:5009/mixology/user/create">here</a>.</p>
    <% } else { %>
        <p>If you want to create your own drinks, you can create your own account with Mixology by clicking <a href="https://mixology.com/user/create">here</a>.</p>
    <% } %>
<% } %>
</body>
</html>