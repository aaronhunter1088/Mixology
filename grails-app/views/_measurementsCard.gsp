<div class="card" style="border:double #000000;width:400px;height:300px;">
    ...
    <div id="measurementsTable" style="display:inline-flex;">
        ...
        <div id="metric" style="display:inline-block;text-align:right;width:133px;height:300px;padding-right:50px;">
            <p style="font-size:1em;margin:0;color:navy;"><b>Metric</b></p>
