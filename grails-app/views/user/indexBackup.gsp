                ...
                <div id="filter" style="text-align:center;padding:10px;display:flex;justify-content:center;">
                    ...
                    <g:form action="index" controller="user" name="filterUsers" method="get">
                        <div id="filterUsersFormDiv" style="display:flex;">
                            <label for="id"></label>
                            <input type="text" name="id" id="id" placeholder="${g.message(code:'default.id',default:'id')}" value="${params.id}" style="width:50px;text-align:center;" class="form-control" />
                            <label for="name"></label>
                            <input type="text" name="name" id="name" placeholder="${g.message(code:'default.first.last.name', default:'first/last name')}" value="${params.firstName ?: params.lastName}" style="text-align:center;width:200px;" class="form-control" />
                            ...
                            <input type="text" name="email" id="email" placeholder="${g.message(code:'user.index.email')}" value="${params.email}" style="text-align:center;width:200px;" class="form-control" />
